...
function Iris({ children, className, custom }) {
    const mergedClassName = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("relative rounded-full shadow-neumorphic overflow-hidden flex items-center justify-center", className);
